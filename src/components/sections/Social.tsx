  ...
  return (
    <section id="social" className="py-20">
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-playfair font-bold mb-2 text-white">Connect With Me</h2>
              ...
              <div className="flex justify-center gap-6">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="p-4 rounded-full bg-secondary hover:bg-purple-900/40 transition-colors"
